$(function () {
    ...
    $(window).on('scroll', function (event) {
        ...
        if (scroll < 20) {
            ...
            $(".header_navbar img").attr("src", "./assets/logo.png");
        } else {
            $(".header_navbar").addClass("sticky");
            $(".header_navbar img").attr("src", "./assets/logo-2.png");
        }
    });
    ...
    function mainSlider() {
		//$(".slider-active").not('.slick-initialized').slick();
